  ...
  conexion.onsuccess = (e) => {
    ...
    if (cursor) {
      usuario.innerHTML += `
                <tr>
                    <td>
                        <img src="${cursor.value.image}" style="width:120px;border-radius: 50%;">    
                    </td>
...
function llenarDatos(email) {
    let fomularioPreRellenado = document.querySelector('.fomularioPreRellenado');
    fomularioPreRellenado.style = "display:block;";
...
guardarCambiosUsuario.addEventListener("click", () => {
  ...
  fomularioPreRellenado.style="display:none;";
  guardarCambiosUsuario.style="display:none"
...
function actualizarTablaUsuarios() {
  ...
  let usuario = document.querySelector(".usuario");
  usuario.innerHTML =
    "<tr><th>Avatar</th><th>Email</th><th>Username</th><th>Rol</th><th>Actions</th></tr>";
